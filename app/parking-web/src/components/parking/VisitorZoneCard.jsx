            ...
            zoneSlotPolygons.map((slot) => (
              <Marker
                ...
                icon={divIcon({
                  ...
                  html: `
    <div style="
      width: ${slot.isAccessible
                      ? (isMobile ? 32 : 36)
                      : (isMobile ? 18 : 20)
                    }px;
      height: ${slot.isAccessible
                      ? (isMobile ? 32 : 36)
                      : (isMobile ? 18 : 20)
                    }px;
      border-radius: 9999px;
      background: ${slot.isAccessible
                      ? "#2563eb"
                      : selectedSlot?.number === slot.number
                        ? "#f59e0b"
                        : "rgba(15,23,42,0.82)"
